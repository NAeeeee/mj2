...
@section('content')
    ...
    <div class="container px-lg-5">
        <div class="mb-5">
    <!-- <div class="with mb-4 d-flex justify-content-between align-items-center"> -->
        ...
        <tbody id="post-table-body">
            @foreach ($posts as $post)
                <tr>
                    ...
                    <td class="w-10">{{ $post->reply_at ?? '' }}</td>
                    <td>
    ...
    <!-- 페이지네이션 -->
    <div class="mt-4 aaa" id="pagination-wrapper">
